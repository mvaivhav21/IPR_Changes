...
def parse_args():
    ...
    parser.add_argument('--origin-dir', default='/scratch/vaibhav/Bayesian-Crowd-Counting/UCF-QNRF_ECCV18',
                        help='original data directory')
    parser.add_argument('--data-dir', default='/scratch/vaibhav/Bayesian-Crowd-Counting/datasetsprocessed/train',
